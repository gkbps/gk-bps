...
export class ThemeComponent extends BaseComponent implements OnInit, OnDestroy {
  ...
  pageTitle = 'Theme';
  sidebarMenuJSONFile = 'theme.menu.json';
  globalConfig = {
    language: true,
    trackHistory: true
  };
  ...
  ngOnInit() {
    ...
    // Do not initialize Sidebar Menu as it is generated in page
  ...
  initMenu() {
    return [
      ...
      {
          data: {label: 'others', icon: 'format_color_fill'},
          children: [
            {
              data:
                {
