...
export class GkClnForm implements OnInit, OnDestroy, OnChanges {
  ...
  ngOnInit() {
    ...
    // IMPORTANT: Only from and after OnInit, all inputs is fully passed to component
  ...
  //   console.log(event);
  //   this.onInFormAction.emit({action: event.action});
  //   switch (event.action) {
  //     case '11':
  //       this.isNewCreationSuccess = false;
  //       break;
  //     default:
  //       break;
  //   }
