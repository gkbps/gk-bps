...
@Component({
  selector: 'h-tray-table',
  templateUrl: './hTurboTableForTray.html',
  styleUrls: ['hTurboTableForTray.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class HTurboTableForTrayComponent implements OnInit, OnDestroy {

  myScope = 'h-tray-table';
